                 ...
                 tabPanel("Bray-Curtis PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              sliderInput("PEnvScaling","Modify triplot arrow scaling",min = 0, max = 20.0,value = 0.02,step = 0.01),
                              hr(style = "border-width: 3px"),
                 ...
                 tabPanel("UniFrac PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              sliderInput("UniPEnvScaling","Modify triplot arrow scaling",min = 0, max = 20.0,value = 0.02,step = 0.01),
                              hr(style = "border-width: 3px"),
