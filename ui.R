                 ...
                 tabPanel("Taxonomy relative abundance",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              selectInput("BarTaxonLevel", label = "Colour by which level?", choice = c("Species","Genus","Family","Order","Class","Phylum","Domain","Sub1","Sub2","Sub3","Sub4")),
                 ...
                 tabPanel("Bray-Curtis PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              numericInput("PEnvScaling","Modify triplot arrow scaling (lower values produce larger arrows)", value = 0.02),
                              hr(style = "border-width: 3px"),
                 ...
                 tabPanel("UniFrac PCoA Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              numericInput("UniPEnvScaling","Modify triplot arrow scaling (lower values produce larger arrows)",value = 0.02),
                              hr(style = "border-width: 3px"),
                 ...
                 tabPanel("Build Your Own Triplot",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              numericInput("BYOPEnvScaling","Modify triplot arrow scaling (lower values produce larger arrows)",value = 0.02),
                              hr(style = "border-width: 3px"),
